...
REPORT_FILE = r"d:\FinalCodeAndFile\lab-management-system\API_TEST_REPORT_FINAL.md"
RESULTS_FILE = r"d:\FinalCodeAndFile\lab-management-system\api_test_results.json"
...
def test_endpoint(service_name, method, endpoint, params=None, json_data=None, expected_status=200, test_name="", note=""):
...
def generate_report():
    ...
    # 生成Markdown报告
    report_content = []
    report_content.append("# 实验室管理系统 - 完整API测试报告\n")
    ...
    report_content.append("### 1. 登录接口空参数验证\n")
